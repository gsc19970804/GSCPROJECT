...
public class B3Adapter extends RecyclerView.Adapter<B3Adapter.MH> {

    private List<DingDanBean.DataBean> list;
    private Context context;

    public B3Adapter(List<DingDanBean.DataBean> list, Context context) {
        this.list = list;
    ...
    public MH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MH(View.inflate(context, R.layout.b3adapter, null));
    }
