...
public class SortLeftAdapter extends RecyclerView.Adapter<SortLeftAdapter.MVH> {
    ...
    public void setpostin(int positon) {
        this.selposition = positon;
    }
    ...
    public void onBindViewHolder(final MVH holder, final int position) {
        ...
        //设置条目点击时的颜色
        if (position == getpostin()) {
            holder.sortname.setBackgroundResource(R.color.selector);
        } else {
            holder.sortname.setBackgroundResource(R.color.noselector);
        }
